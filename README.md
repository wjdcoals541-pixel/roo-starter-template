...
현재 파일은 R2 bucket의 상대 경로로 관리합니다. `sticker.file`은 `001.gif`, `lumicon/001.webp` 같은 상대 경로만 사용합니다. `R2_BASE_URL` 끝에는 마지막 슬래시를 넣지 않습니다.
...
pack name: 루미콘
emoji: 💬
files: lumicon/001.webp ~ lumicon/093.webp
```
